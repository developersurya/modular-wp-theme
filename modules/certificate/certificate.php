 ...
 * # Check the content/layouts/certificate.php for query details
...
//include('tpl/certificate--default.tpl.php');

function lds_travel_certificate($data=array()) {
    //var_dump($data);
    ...
    include('tpl/certificate--two.tpl.php');
