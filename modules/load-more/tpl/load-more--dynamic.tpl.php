...
//We need to change data-term for dynamic taxonomy.
//if ($data) {
$post_id = get_the_ID();
...
<div class="lds_travel_loadmore btn btn-border uppercase" data-term="<?php echo $post_data->post_name;?>">LOAD MORE REVIEWS</div>
